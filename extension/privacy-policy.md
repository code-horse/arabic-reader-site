...
- The Extension uses bundled Tashkeel dictionaries and NLP algorithms within the extension.
...
- All Tashkeel annotation, dictionary lookup, and text-to-speech features within the PDF reader operate locally.
...
- You can also clear extension data via Chrome Settings > Extensions > Arabic Reader > Details > Clear Data.
